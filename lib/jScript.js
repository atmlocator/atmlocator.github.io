   ...
   // console.log("+++++++",comp,"destination is",dest);
    ...
    if (status == 'OK') {
      directionsDisplay.setDirections(result);
        ...
        td1.innerHTML=origin
        td2.innerHTML=dest
        td3.innerHTML= "<b>"+len+"<b>"
        ...
        document.getElementById("detailSpec").appendChild(tbody);
        ...
        td1.innerHTML=obj.instructions
        td2.innerHTML=obj.distance.text
        td3.innerHTML=obj.duration.text
